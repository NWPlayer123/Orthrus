...
pub(crate) enum UsageHint {
    ...
    Stream,
    /// The data will be modified at runtime and re-rendered. Used for data modified at runtime like
    /// animated or soft-skinned vertices.
    Dynamic,
    /// The data will be created once, and used to render many times without being modified. This is
    /// the most common, since usually vertex data isn't directly animated.
    Static,
